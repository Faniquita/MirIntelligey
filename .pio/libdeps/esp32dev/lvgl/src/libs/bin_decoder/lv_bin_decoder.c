                                    ...
                                    const lv_area_t * full_area, lv_area_t * decoded_area)
{
    ...
    if(decoded_area->y1 == LV_COORD_MIN) {
        ...
        lv_color_format_t cf_decoded = LV_COLOR_FORMAT_IS_INDEXED(cf) ? LV_COLOR_FORMAT_NATIVE_ALPHA : cf;
    ...
    if(cf == LV_COLOR_FORMAT_NATIVE_ALPHA || cf == LV_COLOR_FORMAT_XRGB8888 || cf == LV_COLOR_FORMAT_RGB888
