...
#define LV_USE_IMG 1               // Garante que imagens estão habilitadas
#define LV_IMG_CF_ALPHA 1          // Habilita imagens com transparência simples (1 bit alpha)

/*Swap the 2 bytes of RGB565 color. Useful if the display has an 8-bit interface (e.g. SPI)*/
#define LV_COLOR_16_SWAP 0

#define LV_COLOR_FORMAT_ARGB8888 0 // Suporte a imagens ARGB8888
